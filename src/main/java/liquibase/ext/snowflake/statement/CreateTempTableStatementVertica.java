...
/**
 * Created by vesterma on 8/3/2015.
 */
public class CreateTempTableStatementVertica  extends CreateTableStatement {
    ...
    public CreateTempTableStatementVertica(String catalogName, String schemaName, String tableName) {
